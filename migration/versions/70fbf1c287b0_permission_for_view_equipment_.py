"""permission for view equipment permissions

Revision ID: 70fbf1c287b0
Revises: ab1234567890
Create Date: 2025-07-06 13:51:03.995387
"""
...
revision: str = '70fbf1c287b0'
down_revision: Union[str, None] = 'ab1234567890'
...
def upgrade():
    ...
    if permission_row:
        ...
        op.bulk_insert(permissions_table, [
            {'id': permission_id, 'name': 'VIEW_EQUIPMENT_BOOKINGS', 'category': 'GET'}
        ])
    # Assign to roles
